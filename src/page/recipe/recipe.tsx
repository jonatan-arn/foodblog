  ...
  return (
    <>
      ...
      <div className="grid lg:grid-cols-3 lg:grid-rows-1">
        <div className="flex lg:justify-end justify-center lg:mr-5">
          <img
        ...
        <div className="lg:my-5 lg:mx-0 m-5">
          <div>
            Small description about de recipe i should be a two or one line, no
            more because it cant feat
          </div>
          <div className="grid grid-cols-2  grid-rows-2 lg:gap-x-12 lg:gap-y-10 gap-x-5 gap-y-4">
            <div>Curry</div>
            <div>1 serving</div>
            <div>15min</div>
            <div>30 kcal</div>
